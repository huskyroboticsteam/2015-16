// ---------------------------------------------------------------------------
// While the Ultrasonic library's primary goal is to interface with ultrasonic sensors, interfacing with
...
// these methods use Timer2, as does Ultrasonic's ping_timer method for using ultrasonic sensors.  You
...
void setup() {
  ...
  Ultrasonic::timer_ms(500, toggleLED); // Create a Timer2 interrupt that calls toggleLED in your sketch once every 500 milliseconds.
}
