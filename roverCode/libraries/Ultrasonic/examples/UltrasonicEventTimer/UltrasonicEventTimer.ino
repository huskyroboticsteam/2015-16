// ---------------------------------------------------------------------------
// This example shows how to use Ultrasonic's ping_timer method which uses the Timer2 interrupt to get the
...
Ultrasonic sonar(TRIGGER_PIN, ECHO_PIN, MAX_DISTANCE); // Ultrasonic setup of pins and maximum distance.
